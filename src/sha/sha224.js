...
const sha224 = (data, salt=null, encoding='hex') => {
	...
	return crypto.createHash('sha224').update(mix(data, salt)).digest().toString(encoding);
};

/**
 * Calculates the SHA-224 hash of the given data and performs RSA encryption using provided keys.
 * @param {string | Buffer} data - The data to be hashed.
...
module.exports = {sha224, sha224rsa};