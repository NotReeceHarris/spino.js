...
/**
 * Encrypts plaintext using AES-256-CFB1 encryption with the specified key and IV.
...
/**
 * Decrypts encrypted data using AES-256-CFB1 decryption with the specified key and IV.
