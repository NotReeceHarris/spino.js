...
/**
 * Encrypts plaintext using AES-256-CFB encryption with the specified key and IV.
...
/**
 * Decrypts encrypted data using AES-256-CFB decryption with the specified key and IV.
