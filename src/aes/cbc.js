...
/**
 * Encrypts plaintext using AES-256-CBC encryption with the specified key and IV.
...
/**
 * Decrypts encrypted data using AES-256-CBC decryption with the specified key and IV.
