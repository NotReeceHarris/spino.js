...
/**
 * Encrypts plaintext using AES-256-GCM encryption with the specified key and IV.
...
/**
 * Decrypts encrypted data using AES-256-GCM decryption with the specified key and IV.
