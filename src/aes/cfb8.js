...
/**
 * Encrypts plaintext using AES-256-CFB8 encryption with the specified key and IV.
...
const encrypt = (plaintext, key, iv, encoding='hex') => {
	...
	const cipher = crypto.createCipheriv('aes-256-cfb8', key, iv);
...
/**
 * Decrypts encrypted data using AES-256-CFB8 decryption with the specified key and IV.
